...
/// </summary>
public abstract class Script_Instance_a771e : GH_ScriptInstance
{
  ...
  private void RunScript(double x, double t, ref object A, ref object B, ref object C, ref object D)
  {
    ...
    //Deductive Geometry
    //write an algothim that demonstrates the Angle Sum Triangle Theorem three corollaries
    //create a XZ plane
    Plane plane = new Plane(new Point3d(0, 0, 0), new Vector3d(0, 0, 1));
    //create a circle on the plane
    Circle circle = new Circle(plane, x);

    //create three points on the circle at point t, t/3, and 2*t/3
    Point3d pt1 = circle.PointAt(t);
    Point3d pt2 = circle.PointAt(t / 3);
    Point3d pt3 = circle.PointAt(2 * t / 3);
